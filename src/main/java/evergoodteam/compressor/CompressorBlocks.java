...
public class CompressorBlocks {
    ...
    public static final Block COMPRESSED_BLACKSTONE = new BlockBase(2.5f, 7.0f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block DOUBLE_COMPRESSED_BLACKSTONE = new BlockBase(5.75f, 8.7f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block TRIPLE_COMPRESSED_BLACKSTONE = new BlockBase(11.25f, 11.1f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block QUADRUPLE_COMPRESSED_BLACKSTONE = new BlockBase(19.0f, 14.2f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block QUINTUPLE_COMPRESSED_BLACKSTONE = new BlockBase(29.0f, 18.0f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block SEXTUPLE_COMPRESSED_BLACKSTONE = new BlockBase(41.25f, 22.5f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block SEPTUPLE_COMPRESSED_BLACKSTONE = new BlockBase(55.75f, 27.7f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    public static final Block OCTUPLE_COMPRESSED_BLACKSTONE = new BlockBase(72.5f, 33.6f, BlockSoundGroup.STONE).addTo(BLACKSTONE).addTo(BLOCKS);
    ...
    public static final ItemGroup COMPRESSOR_GROUP = ItemGroupBase.createItemGroup(MODID, "itemgroup", OCTUPLE_COMPRESSED_COBBLESTONE).getGroup();
}
